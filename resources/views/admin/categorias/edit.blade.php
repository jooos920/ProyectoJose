...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('categorias.update', $categoria->id) }}" method="POST" id="form">
            @csrf
            @if ($errors->any())
            ...
            <div class="mb-3">
                ...
                <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $categoria->name) }}">
            </div>
